...
const Page = ({
  ...
  return !styleButton ? (<Button style={flatButtonStyle} onClick={onClick}>{value.toString()}</Button>) : 
  (<div style={isActive ? stylePrimary : styleButton} label={value.toString()} onClick={onClick}>{value}</div>);
...
const FirstPageLink = ({ onClick, styleFirstPageLink }) => {
    return !styleFirstPageLink ? (<Button style={flatButtonStyle} onClick={onClick} >{"<"}</Button>) : 
...
const LastPageLink = ({ onClick, styleLastPageLink }) => {
  return !styleLastPageLink ? (<Button style={flatButtonStyle} onClick={onClick} >{">"}</Button>) :
